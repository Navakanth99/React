...
function Card({username, header} ) {
    console.log( username);
  return (
    <>
     <div className="w-60 h-60 rounded-xl bg-black rounded-xl"> {header}
        <img
        ...
        <div className="glass py-4 px-5 relative -top-[3.4rem]  rounded-b-xl z-10">
          <h1 className="font-bold  font-mono  text-xl bg-black rounded-xl">{username || "user"}</h1>
